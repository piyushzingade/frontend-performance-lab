...
export function LegacyLab() {
  ...
  return (
    <div className="lab">
      <header>
        <h1>100K-Row Table Lab</h1>
        <p className="sub">100K-row rendering experiment (original standalone lab, kept for reference) — baseline vs. virtualization vs. memoization vs. worker</p>
